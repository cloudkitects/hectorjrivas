...
// Created	: Mon Sep 14 14:55:03 CDT 2015
// Updated	: Mon Sep 14 14:55:08 CDT 2015
// Purpose	: customize the syntax instance.
//////////////////////////////////////////////////////////////////////////////////////////////
...
function Load2()
{
	...
	with (syntax)
	{
		...
		addGroup("sampleclasses", "CustomEncryptor GamerAccount USOnlyRouteHandler USIPHandler RequestContext ServerContext ReservationModelBinder ControllerContext ModelBindingContext ReservationLocation ProductModel DBAccess UnitTest",
//			rules["classes"] + "border-bottom:1px dotted #31BDB5;");
		"color: #D68AD3;");
		...
		addGroup("classes", "Controller DateTimeOffset ContactPicker ContactManager ContactPickerUI ContactInformation SearchPane BackgroundExecutionManager FormsAuthentication WindowsAuthenticationModule PassportAuthenticationModule PasswordCredentialPropertyStore PasswordCredential Calendar XmlDocument OnlineIdAuthenticator NetworkCredential PasswordVault LSAuthenticationObject PSCredential LSCredentialFormContext Frame StorageFile NavigationHelper TimeSpan MediaElement CoreWindow ApplicationSettings SettingsPane SettingsCommand SettingsFlyout AppSettingsFlyout ActionResult",
			rules["classes"]);

		addGroup("testing", "Assert TestMethod", rules["classes"]);
	}
