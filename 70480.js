...
// Purpose	: customize a syntax instance with sample classes and interfaces and
...
// Purpose	: add any customizations to the syntax.
//////////////////////////////////////////////////////////////////////////////////////////////
function Load2()
{
	// add syntax customizations
	var syntax = Syntaxes.find("language", "JavaScript");

	if (syntax == null)
	{
		syntax = LoadSyntax("JavaScript");
	...
	with (syntax)
	{
		...
		//addGroup("samplefunctions", "", rules["classes"]);
	
		// objects that eventually should be moved to syntax.css
		//addGroup("classes", "", rules["classes"] + "border-bottom:1px dotted #31BDB5;");
	}
	
	// add  rules to override syntax default styles
	addRule(null, ".JavaScript, .XAML, SELECTOR", "border-radius: 0; background: transparent;");
...
// Created	: Fri Jan 30 15:48:48 CST 2015
// Updated	: Fri Feb 20 11:10:52 CDT 2015, parses custom JAVASCRIPT elements also.
//////////////////////////////////////////////////////////////////////////////////////////////
function ApplySyntaxHighlighting2()
{
	// parse code fragments
	var codeFragments1 = document.getElementsByTagName("JAVASCRIPT");
	...
	for (var i = 0; i < codeFragments.length; i++)
	{
		...
		{
		case "JAVASCRIPT": codeFragment.className = "JavaScript"; break;
